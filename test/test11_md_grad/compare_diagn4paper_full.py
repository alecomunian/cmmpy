...
diagn3.append({"file": "../out/test11_md_grad/09_00-10-20-30_gr0d0015_std00/out/diagn.csv",  "nbd": "0 cm"})
diagn3.append({"file": "../out/test11_md_grad/10_00-10-20-30_gr0d0015_std05/out/diagn.csv",  "nbd": "5 cm"})
diagn3.append({"file": "../out/test11_md_grad/11_00-10-20-30_gr0d0015_std10/out/diagn.csv",  "nbd": "10 cm"})
diagn3.append({"file": "../out/test11_md_grad/12_00-10-20-30_gr0d0015_std20/out/diagn.csv",  "nbd": "20 cm"})
...
ax[1].legend(custom_lines, ("0 cm", "5 cm", "10 cm", "20 cm"))


pl.savefig("nbd_diagn4paper_strct.png", dpi=400)
pl.savefig("nbd_diagn4paper_strct.pdf")
pl.show()    
