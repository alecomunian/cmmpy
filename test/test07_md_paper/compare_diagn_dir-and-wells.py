...
for i in range(8):
    diagnw.append({"file": "../test06_wells1a1/{0:02d}_wells{1:02d}/out/diagn.csv".format(i+1, i+1), "wells": i+1})
    
# For the direction
diagnd = []

diagnd.append({"file": "01_S/out/diagn.csv", "nbd": "S" })
diagnd.append({"file": "02_S-SW/out/diagn.csv",  "nbd": "S, SW"})
diagnd.append({"file": "03_S-SW-W/out/diagn.csv",  "nbd": "S, SW, W"})
diagnd.append({"file": "04_S-SW-W-NW/out/diagn.csv",  "nbd": "S, SW, W, NW"})
