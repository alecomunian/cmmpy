...
head_file1 = "01_arith/out/ref/ds000/test.hds"
head_file2 = "01_arith/out/ref/ds001/test.hds"
head_file3 = "01_arith/out/ref/ds002/test.hds"
head_file4 = "01_arith/out/ref/ds003/test.hds"
...
levels = np.linspace(h_min, h_max, int((h_max-h_min)*2)+1)
...
levels = np.linspace(h_min, h_max, int((h_max-h_min)*1)+1)
ax[1,0].set_title("c) south-west (S-W)")
...
levels = np.linspace(h_min, h_max, int((h_max-h_min)*1)+1)
ax[1,1].set_title("d) north-west (N-W)")
